...
## Environments
- Preview: https://main--maji-sp-24--aemysites.aem.page/
- Live: https://main--maji-sp-24--aemysites.aem.live/
- Block Library: https://main--maji-sp-24--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `maji-sp-24` directory in your favorite IDE and start coding :)
